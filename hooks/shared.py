...
# Consistent timezone for all hooks — same logic as scripts/config.py.
_tz_name = os.environ.get("METAMODE_TIMEZONE")
LOCAL_TZ = ZoneInfo(_tz_name) if _tz_name else datetime.now(timezone.utc).astimezone().tzinfo  # type: ignore[assignment]
