...
This skill requires the NotebookLM CLI. See the NotebookLM skill (`/notebooklm`) for setup instructions:
1. Install: `pip install "notebooklm-py[browser]"` and `playwright install chromium`
2. Authenticate: run the login flow from the notebooklm skill
