...
1. **Content generation** — podcasts, videos, slide decks, quizzes, reports from your knowledge base
2. **External brain for token savings** — offload context to NotebookLM instead of stuffing it into Claude's context window
...
- **NotebookLM** is triggered manually via `/notebooklm`
